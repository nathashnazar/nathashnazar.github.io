...
try {
    ...
    //Recipients
    $mail->setFrom('nathashnazar16@gmail.com', 'Mailer');         //Set the sender of the message (your email address)
    $mail->addAddress('reemaachi2684@g,ail.com', 'Joe User');     //Add a recipient (your bae's email address)
